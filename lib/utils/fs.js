...
exports.writeTS = exports.writeMock = exports.writeJSON = exports.createFileSync = void 0;
...
function writeMock(fileName, data) {
    fs_extra_1.default.writeFile(`./src/mock/${fileName}`, JSON.stringify(data, null, "\t"), null, () => {
    });
}
exports.writeMock = writeMock;
function writeTS(fileName, content) {
    fs_extra_1.default.writeFile(`./src/mock/${fileName}`, content, null, () => {
    });
}
